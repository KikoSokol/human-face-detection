...
for file_name in npz_files:
    ...
    sv.to_mp4(directory_name, file_name_without_suffix, "ORIGINAL", video_file["colorImages_original"],
              video_file["landmarks2D"],
              video_file["boundingBox"])
    sv.to_mp4(directory_name, file_name_without_suffix, "MEDIUM", video_file["colorImages_medium"],
              video_file["landmarks2D"],
              video_file["boundingBox"])
    sv.to_mp4(directory_name, file_name_without_suffix, "SEVERE", video_file["colorImages_severe"],
              video_file["landmarks2D"],
              video_file["boundingBox"])
